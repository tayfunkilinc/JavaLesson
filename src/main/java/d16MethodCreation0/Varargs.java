...
public class Varargs {
    public static void main(String[] args) {
        //Variable arguments - Değişken Sayılı ARGÜMANLAR yani argümanların değişken sayıda olduğu methodlar
   ...
   /* public static int add1(int a, int b) {
    ...
    public  static int add(int... a){ // 3 nokta koyduğumuzda Java bunu varargs kabul eder
        int sum =0;
        for (int w : a){
            sum = sum +w;
        }
