...
public class InvalidStudentGradeException extends Exception{ // burda ana yapi uzerinden hata olusturulu o nedenle extends Exception kullanarak basladik
    // biz kendimiz bir exeption olusturalim
    /*
    ...
    public InvalidStudentGradeException(String message) { // sag tiklayip Genarate kismindan Constructur olusturduk
        super(message);
    }
}
