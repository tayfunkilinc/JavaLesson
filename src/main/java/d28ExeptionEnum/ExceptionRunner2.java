...
public class ExceptionRunner2 {
    public static void main(String[] args) {
        numberOFStudents(-67); // InvalidNumberException: Bir Okuldaki Ogrenci Sayisi Negatif Olamaz
    }
    ...
    ancak modern Java uygulamalarında kullanımı önerilmez. Artik Otomatik olarak cagrilir*/
}
