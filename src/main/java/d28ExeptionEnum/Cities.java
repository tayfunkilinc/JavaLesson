...
public enum Cities {
   ...
   enum'un temel avantajları şunlardır:
    ...
    Ve dis kaynaklara bagimliligi kaldirir.
...
/
    ...
    //degisiklikleri onlemek icin private ve final yapiyoruz
    ...
    private final int plateCode; // disardan erisilemez ve degistirilemez bir degisken olusturduk
