...
public class InstanceBlock1 {
                ...
                //static blok program çalışınca direk çalışır ama intance blok nesne oluşturulunca çalışır ne kadar nesne varsa her nesne için çalışır
               ...
               oluşturulduğunda, otomobilin rengini ve yakıt türünü belirlemek için instance bloklarını kullanabilirsiniz.
                ...
                //Instance block oluşturalım (iki süslğ parantez arasına yazılan koddur)
                {
                    System.out.println("Merhaba Burası Instance Block");
                }
    public static void main(String[] args) {
                    InstanceBlock1 obj1 = new InstanceBlock1(); //Merhaba Burası Instance Block
                    InstanceBlock1 obj2 = new InstanceBlock1(); //Merhaba Burası Instance Block
    }
}
